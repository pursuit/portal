...
func (x *GetUserBalancePayload) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetUserBalanceResponse) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_portal_user_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x15, 0x47, 0x65,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x16,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x46,
